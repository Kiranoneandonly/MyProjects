...
class CoreGUI(object):
    def __init__(self,parent):
        ...
        button = Button(self.parent, text="Create ICE", command=self.run_process)
    ...
    def run_process(self):
        ...
        # p = subprocess.Popen(['python','streetLampAutomation.py', self.bucket_name,self.credential_path], stdout=subprocess.PIPE, stderr=subprocess.STDOUT)
    ...
    def update(self):
        with open("log.txt","r") as f:
            ...
            #print(data)
            if((data.count("waiting for stack to be ready...")==1 and data.count("finished stack creation")==0)or
                (data.count("Delete stack initiated")==1 and data.count("finished deleting stack")==0)):
                #print("inside 1st if")
            ...
            elif((data.count("finished deleting stack")==1)):
