...
class CommentDetailsForm(CommentSecurityForm):
    ...
    """
    comment = forms.CharField(label=_('Messages'), widget=forms.Textarea, 
                              max_length=COMMENT_MAX_LENGTH)

    def __init__(self, *args, **kwargs):
        super(CommentDetailsForm, self).__init__(*args, **kwargs)

        self.fields['comment'].label = ""
        self.fields['comment'].widget.attrs['placeholder'] = _("Add Message")
        self.fields['comment'].widget.attrs['cols'] = '40'
        self.fields['comment'].widget.attrs['rows'] = '5'
        self.fields['comment'].widget.attrs['style'] = 'height: 100%; width: 100%;'
        self.fields['comment'].widget.attrs['class'] = 'comment_field'
    ...
    def get_comment_create_data(self):
        ...
        return dict(
            ...
            # user_type=self.target_object.client_poc.user_type,
