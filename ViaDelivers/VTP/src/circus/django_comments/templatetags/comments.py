...
class BaseCommentNode(template.Node):
    ...
    def get_queryset(self, context):
        ...
        qs = self.comment_model.objects.filter(
            ...
            notification_type=settings.NOTIFICATION_TYPE_MESSAGE,
        )
...
@register.simple_tag
def del_message_tab_session(request):
    if request.session.get('tab_session_name', False):
        del request.session['tab_session_name']
    return ''
