...
def user_type(request):
    current_user = request.user.is_vendor()
    if current_user:
        template_include = "vendors/theme_base.html"
        profile_url = 'vendor_edit_profile'
    else:
        template_include = "shared/external/theme_base.html"
        profile_url = 'edit_profile'
    return template_include, profile_url
...
def add(request, extra_context=None, next_override=None,
    ...
    template, profile_url = user_type(request)
    context = {
        'avatar': avatar,
        'avatars': avatars,
